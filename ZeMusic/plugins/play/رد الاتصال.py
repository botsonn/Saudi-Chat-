...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸", url="https://t.me/ww_2_2"
                    )
                ],
            ]
        ),
...
InlineKeyboardButton(" member keyboard ", callback_data="ww_2_2"),
                ],
                [                
...
@Client.on_callback_query(filters.regex("ww_2_2"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🐰 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع افيونا من هن : @ww_2_2 **
\n __ Developer by [𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸](https://t.me/ww_2_2)""",
        reply_markup=InlineKeyboardMarkup(
...
\n__ Developer by [𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸](https://t.me/ngd_2)""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )

@Client.on_callback_query(filters.regex("ngd_2"))
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول جروب التواصل بلاسفل..↑↓ \n\n [𝖥𝗈𝗋 ᥲ️ᖴY᥆ꪀᥲ️ . 💸](https://t.me/ww_2_2)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("القناة", url=f"https://t.me/ngd_2"),
                    InlineKeyboardButton("الجروب", url=f"https://t.me/Ng_333"),
                ],
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/ngd_2BOT"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/Taw"),
                ],
                [InlineKeyboardButton("ᖴ᥆ᖇ. 🐉", url=f"https://t.me/ww_2_2")],
            ]
        ),
  )
